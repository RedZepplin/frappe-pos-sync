# ---
# Functions used by FrappePOSOrder
# ---
import frappe
import json
...
def fetch_items():
    print("sulod")
    use_price_list = frappe.db.get_single_value('Frappe POS Settings', 'use_price_list')
